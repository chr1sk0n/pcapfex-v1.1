...
from core.ThreadPool.Pool import Pool
from core.Files.FileManager import *
from core.Files.FileObject import *
...
class Dispatcher:
    ...
    def _finishedSearch(self, datastructure):
        (stream, result) = datastructure
    ...
    def run(self):
        ...
        print("\nStream Reassembly finished.\n\tFile %s has a total of %d single-direction streams." % (
        self.pcapfile, len(allstreams)))
